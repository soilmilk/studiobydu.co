      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-neutral-700">
            ...
            software runtimes; sometimes its competitive leagues. In both cases,
            the goal is the same: turn messy reality into decisions we can
            trust.
          </p>
        </div>

        <div className="rounded-2xl border border-neutral-200 p-5">
          <p className="text-sm text-neutral-600">past side quests . . .</p>
          <ul className="mt-3 list-disc pl-5 text-neutral-800">
            <li>
              <span className="font-medium">detailing out Bezout's Lemma </span>{" "}
              <a
            ...
            <li>
              <span className="font-medium">
                storytelling 15 years of violence{" "}
              </span>{" "}
              <a
                ...
                className="underline hover:text-neutral-600"
              >
                (VT Dept. of Statistics, SIGNIFIANCE Journal)
              </a>
            </li>
          </ul>
        </div>
